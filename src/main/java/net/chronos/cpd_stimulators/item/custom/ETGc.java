...
public class ETGc extends Item {
    ...
    public ETGc(Properties properties) {
        ...
        positives.add(Pair.of(Triple.of("minecraft:saturation",                 60, 1), 0));
        // positives.add(Pair.of(Triple.of(MobEffects.SATURATION,          90, 0), 0));
        positives.add(Pair.of(Triple.of("minecraft:fire_resistance",            90, 0), 0));
        positives.add(Pair.of(Triple.of("cpd_stimulators:stress_resistance",    30, 0), 0));
