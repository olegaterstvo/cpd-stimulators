...
public class Trimadol extends Item {
    ...
    public Trimadol(Properties properties) {
        ...
        positives.add(Pair.of(Triple.of(MobEffects.DAMAGE_RESISTANCE,       180, 0), 0));
//        positives.add(Pair.of(Triple.of(MobEffects.SATURATION,              180, 0), 0));
        positives.add(Pair.of(Triple.of(ModEffects.STRESS_RESISTANCE,       180, 0), 0));

        negatives.add(Pair.of(Triple.of(MobEffects.HUNGER,                  180, 0), 1));
    }
