...
public class BTG2A2 extends Item {
    ...
    private void addEffects(Player player) {
        player.addEffect(new MobEffectInstance(MobEffects.LUCK, 18000, 0));
        player.addEffect(new MobEffectInstance(MobEffects.NIGHT_VISION, 18000, 0));
        // weight limit +15%
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.literal("§o§7"+"1" + Component.translatable("misc.cpd_stimulators.delay").getString()
                + "900" + Component.translatable("misc.cpd_stimulators.duration").getString()));
