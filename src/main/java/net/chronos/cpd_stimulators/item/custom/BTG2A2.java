...
public class BTG2A2 extends Item {
    ...
    public BTG2A2(Properties properties) {
        ...
        positives.add(Pair.of(Triple.of(MobEffects.LUCK,            900, 0), 0));
        positives.add(Pair.of(Triple.of(MobEffects.NIGHT_VISION,    900, 0), 0));

        negatives.add(Pair.of(Triple.of(MobEffects.HUNGER,          900, 0), 1));
    }
