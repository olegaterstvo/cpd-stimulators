...
public class Obdolbos extends Item {
    ...
    private void addEffects(Player player) {
        ...
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:speed",                     600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:strength",                  600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:glowing",                   600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:night_vision",              600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:resistance",                600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:hero_of_the_village",       600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:regeneration",              600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:saturation",                600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:haste",                     600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:dolphins_grace",            600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:water_breathing",           600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:slow_falling",              600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:jump_boost",                600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("minecraft:invisibility",              600, 0), 1));
        if (rnd.nextInt(4) == 0) positives.add(Pair.of(Triple.of("cpd_stimulators:stress_resistance",   600, 0), 1));
    ...
    private void addSideEffects(Player player) {
        ...
        if (rnd.nextInt(4) == 0) negatives.add(Pair.of(Triple.of("toughasnails:thirst",             600, 0), 1));
